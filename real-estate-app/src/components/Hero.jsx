...
          className="bg-[#1E3A8A] text-white font-semibold px-8 md:px-12 py-4 rounded-full hover:bg-blue-800 transition text-lg shadow-md h-[56px] min-w-[200px] flex items-center justify-center w-full md:w-auto"
        >
          Find Property
        </button>
      </div>
